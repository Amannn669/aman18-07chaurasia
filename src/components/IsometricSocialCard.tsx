...
interface IsometricSocialCardProps {
...
const IsometricSocialCard: React.FC<IsometricSocialCardProps> = ({ direction = 'vertical' }) => {
  return (
...
const StyledWrapper = styled.div<{ $direction: 'vertical' | 'horizontal' }>`
  .card {
    ...
    box-shadow: inset 0 0 20px rgba(255, 255, 255, 0.1),
      inset 0 0 5px rgba(255, 255, 255, 0.15), 0 5px 5px rgba(0, 0, 0, 0.164);
    transition: 0.5s;
  }
  ...
  .svg {
    ...
    box-shadow: inset 0 0 20px rgba(255, 255, 255, 0.15),
      inset 0 0 5px rgba(255, 255, 255, 0.25), 0 5px 5px rgba(0, 0, 0, 0.164);
  }
  ...
  .text {
    ...
    box-shadow: -5px 0 1px rgba(153, 153, 153, 0.1),
      ...
      inset 0 0 5px rgba(255, 255, 255, 0.25), 0 5px 5px rgba(0, 0, 0, 0.082);
  }
...
export default IsometricSocialCard;
